								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="basic-datatables" class="display table table-striped table-hover" >
											...
											<tbody>
											<c:forEach var="logs" items="${crfiles}">
								                <tr>
								                    <td>${logs.defendabt_name}</td>
								                    <td>${logs.crime_name}</td>
								                    <td>${logs.date_of_imprisonment}</td>
								                    <td>${logs.date_of_crime_and_time}</td>
								                    <td>${logs.date_filed_on}</td>
								                    <td>${logs.sentence}</td>
								                </tr>
								            </c:forEach>
											</tbody>
