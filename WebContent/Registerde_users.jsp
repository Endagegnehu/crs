									...
									<div class="table-responsive">
										<table id="basic-datatables" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<c:url var = "udate_users_link" value = "updateForm" >
													<c:param name="idusers" value="${ users.idusers}" ></c:param>
												</c:url>
												
												<c:url var = "delete_users_link" value = "delete" >
													<c:param name="idusers" value="${ users.idusers}" ></c:param>
												</c:url>
												<tr>
												   ...
												   <td>${users.email } </td>
												   <td>
												   <a href="${ udate_users_link}"> Update</a>
												   </td>
												   <td>
												   		<a href="${delete_users_link}"
												   			onclick="if(!(confirm('Are you sure you want to delete this users?'))) return false">Delete</a>
												   </td>
												</tr>
												</c:forEach>
											</tbody>
