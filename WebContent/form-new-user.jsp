    ...
    <div class="col-md-12">
        <div class="card">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 col-xl-5">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="FirstName" name ="first_name" placeholder="First Name"><br>
                            <label>Last Name</label>
                            <input type="text" class="form-control" id="LastName" name = "last_name" placeholder="Last Name"><br>
                            <label>User Name</label>
                            <input type="text" class="form-control" id="UserName" name = "user_name" placeholder="UserName"><br>
                            <label>Password</label>
                            <input type="text" class="form-control" id="PasswordNewUser" name = "password" placeholder="Password"><br>
                            <small id="emailHelp2" class="form-text text-muted"></small>
                            <label>E-Mail</label>
         					<input type="email" class="form-control" id="EmailNewUser" name = "email" placeholder="E-mail"><br>
        					<div class="form-group">
         					<label>Job</label>
             				...
             				<option>registrar_office</option>
         					</select>
     						</div> 
     					</div>
					</div>
         ...
         <div class="form-group">
			...
			<input type="number" class="form-control" id="Defendant" name="home_number">
		 </div>
         
         <div class="form-group">
			<label for="defendat">Phone Number</label>
			<input type="tel" class="form-control" id="Defendant" name="phon">
		 </div>
		 
		 <div class="form-group">
			<label for="defendat">Region</label>
			<input type="text" class="form-control" id="Defendant" name="region">
		 </div>
		 
		 <div class="form-group">
			<label for="defendat">woreda</label>
			<input type="text" class="form-control" id="Defendant" name="woreda">
		 </div>
		 
		 <div class="form-group">
			<label for="defendat">keble</label>
			<input type="text" class="form-control" id="Defendant" name="kebele">
		 </div>
