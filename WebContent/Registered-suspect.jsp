            ...
            <div class="user">
                <div class="info">
                    <h2 data-toggle="collapse" href="#collapseExample" aria-expanded="true">
							  ...
							  <span class="user-level">Officer <!-- Job of the user from database using session--></span>
							  </span>
                    </h2>
                </div>
            </div>
					  ...
					  <div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Registered suspects</h4>
								</div>
								<div class="card-body">
									<div class="table-responsive">
										<table id="basic-datatables" class="display table table-striped table-hover" >
											...
											<tbody>
											<c:forEach var ="suspect" items="${suspect}">
												<tr>
													<td>${suspect.first_name }</td>
													<td>${suspect.middle_name}</td>
													<td>${suspect.age }</td>
													<td>${suspect.marital_status }</td>
													<td>${suspect.addiction}</td>
												</tr>
												</c:forEach>
											</tbody>
										</table>
