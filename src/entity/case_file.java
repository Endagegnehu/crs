...
{    
    ...
    public case_file(String typeof_crime, String dateof_crime, String crime_tip_date, int log_file_id, String investigation_end_date, int investigator_id, int prosecutor_id, String suspect_name, String short_sumary, int lawyer_id, String prosecutor_approved, String registrar_approved, int judge_id) {
