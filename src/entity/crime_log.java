...
public class crime_log {
	...
	public crime_log(String crime_type, String crime_occurred_date, String crime_registered_date, String defendant_name,
			String plaintiff_name, String assigned_officer_id, String crime_description) {
		super();
	...
	public String toString() {
		return "crime_log [idcrime_log=" + idcrime_log + ", crime_type=" + crime_type + ", crime_occurred_date="
				+ crime_occurred_date + ", crime_registered_date=" + crime_registered_date + ", defendant_name="
				+ defendant_name + ", plaintiff_name=" + plaintiff_name + ", assigned_officer_id=" + assigned_officer_id
